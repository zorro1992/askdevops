...
# But you can see this is repeating variable declaration everytime which
# is not scalable
...
print("Name of the engineer is " + se1.name + " and the role is " +
      se1.role + " and current salary " + str(se1.salary))
print(se1.alias)

# Instance
se2 = Engineer("Ram", "Data Engineer", 25, "Senior", 8000)
print("Name of the engineer is " +
      se2.name +
      " and the role is " +
      se2.role +
      " and current salary " +
...
# Exercise
# Create a class called BankFD. It should have account number, FD amount,
# Nominee
